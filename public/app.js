...
en:{
  ...
  btn_pdf:'📄 Export PDF',btn_ics:'📥 Download .ics',btn_heat:'🔥 Heat Distribution',btn_all:'🌍 All European Countries',
  ...
  wd_title:'Working Days Calculator',wd_desc:'Count business days between two dates, excluding weekends and holidays. Shows breakdown per country.',
  ...
  bd_title:'Bridge Day Optimizer',bd_desc:'Smart leave planning: see exactly which days to take off to maximize consecutive days away. Only high-value opportunities shown.',
  ...
  ta_title:'Team Holiday Alerts',ta_desc:'Monthly impact report showing when team members are off. Red = multiple countries off simultaneously.',
  cmp_title:'Year-over-Year Comparison',cmp_desc:'How holidays shift between years for each selected country. Compare long weekends, disruptions, and clear weeks.',
  ...
  cmp_team:'Combined team view',cmp_anyoff:'Days any team member off',cmp_evweeks:'Everyone-available weeks',
  heat_title:'Heat Distribution',heat_desc:'Non-working day density for {c}.',heat_all:'all {n} European countries',
  heat_weekly:'Weekly Heatmap',heat_monthly:'Monthly Impact ({n} countries, weekdays)',
  heat_clear:'Clear',heat_low:'Low',heat_med:'Medium',heat_high:'High',
  heat_toggle_all:'🌍 Show for all {n} countries',heat_toggle_sel:'← Show selected countries only',
  ac_title:'Non-Working Days — All European Countries',ac_desc:'Tap any country for full profile, holiday list, calendar, and bridge days.',
